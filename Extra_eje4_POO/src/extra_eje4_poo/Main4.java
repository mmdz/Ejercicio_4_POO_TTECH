package extra_eje4_poo;

import extra_eje4_poo.entidades.NIF;
import extra_eje4_poo.servicios.ServiciosNIF;
...
public class Main4 {
    ...
    public static void main(String[] args) {
        ...
        ServiciosNIF verificador = new ServiciosNIF();
         NIF dniA = verificador.crearNIF();
       // verificador.cargarCaracteres();
   
        verificador.mostrar(dniA);
    }
